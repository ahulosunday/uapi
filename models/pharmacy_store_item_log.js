...
module.exports = (sequelize, DataTypes) => {
  class pharmacy_store_item_log extends Model {
    /**
     * Helper method for defining associations.
     * This method is not a part of Sequelize lifecycle.
     * The `models/index` file will call this method automatically.
     */
    static associate({drug, units, route_of_administration,users, measurement, dosage_form, vendor, inventories }) {
  ...
  pharmacy_store_item_log.init({
   // id: DataTypes.INTEGER,
    ...
    sequelize,
    modelName: 'pharmacy_store_item_log',
  });
  return pharmacy_store_item_log;
};